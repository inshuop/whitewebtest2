      ...
      keyframes: {
        ...
        slideBackground: {
          "0%": {
            ...
            transform: "scaleX(1)", // Start from scaleX(0)
            transformOrigin: "left", // Origin from the left
          },
          "100%": {
            backgroundColor: "#3B82F6", // End with blue background
            transform: "scaleX(0)", // End with scaleX(1)
            transformOrigin: "right", // Origin to the right
          },
        },
      },
      animation: {
        ...
        logoFade: "logoFade 2s ease-in-out",
        textFade: "textFade 2s ease-in-out",
        "slide-background" : "slideBackground 2s ease-in-out forwards",
      },
    },
  },
  plugins: [],
