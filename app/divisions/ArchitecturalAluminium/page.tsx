...
// import ProductScrollDisplay from "@/components/divisionhero/archal/ProductScrollDisplay"; 
  ...
  return (
    <div className="dark:bg-black dark:text-white ">
      ...
      <section className="py-10 px-5 bg-white dark:bg-blacksection mt-20">
        ...
        White Aluminium started its operation as an Architectural aluminium fabricator in 1973 at Abu Dhabi Industrial area, UAE. The company has grown substantially and has earned a high reputation within the construction sector introducing quality products and innovative technology, allowing it to become one of the undisputed leaders in the UAE market.

The company has grown to an extent of offering comprehensive solutions to the most sophisticated projects beyond the UAE and Middle East.

Latest, state of the art machinery is installed in the production facilities, and fully automated laser guided equipment is used for optimum quality control and consistency. Installation of all the products are carried out by our fully trained installation crews, under the strict control and supervision of management personnel, to ensure that the company commitment to quality is maintained at all times.
        </p>
      </section>
  ...
  Quick Links
        ...
        <div className="max-w-[75%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {cardbtm.map((car) => (
            <Link key={car.id} href={`/divisions/ArchitecturalAluminium/detail/${car.id}`}>
